...
VL_ATTR_COLD void Vspi_dut___024root__trace_init_sub__TOP__0(Vspi_dut___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+16,0,"master_data",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 15,0);
    ...
    tracep->declBit(c+18,0,"miso",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    ...
    tracep->declBus(c+20,0,"data_received",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 15,0);
    ...
    tracep->declBit(c+22,0,"mosi",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBus(c+23,0,"debug_state",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 2,0);
    tracep->declBit(c+24,0,"ss",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    ...
    tracep->declBus(c+28,0,"DIV_MAX",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+29,0,"DIV_HALF",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    ...
    Vspi_dut___024root__trace_init_sub__TOP__spi_dut__DOT__spi_if__0(vlSelf, tracep);
    tracep->popPrefix();
    tracep->declBus(c+25,0,"sr_rx",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 15,0);
    tracep->declBus(c+26,0,"bit_count",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 3,0);
    tracep->popPrefix();
    tracep->popPrefix();
}
...
VL_ATTR_COLD void Vspi_dut___024root__trace_init_sub__TOP__spi_dut__DOT__spi_if__0(Vspi_dut___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBit(c+10,0,"mosi",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1);
    ...
    tracep->declBit(c+17,0,"start",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBit(c+13,0,"done",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1);
}
...
VL_ATTR_COLD void Vspi_dut___024root__trace_const_0_sub_0(Vspi_dut___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    // Body
    bufp->fullIData(oldp+28,(0x64U),32);
    bufp->fullIData(oldp+29,(0x32U),32);
}
...
VL_ATTR_COLD void Vspi_dut___024root__trace_full_0_sub_0(Vspi_dut___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullBit(oldp+10,(vlSymsp->TOP__spi_dut__DOT__spi_if.mosi));
    bufp->fullBit(oldp+11,(vlSymsp->TOP__spi_dut__DOT__spi_if.ss));
    bufp->fullSData(oldp+12,(vlSymsp->TOP__spi_dut__DOT__spi_if.data_received),16);
    bufp->fullBit(oldp+13,(vlSymsp->TOP__spi_dut__DOT__spi_if.done));
    bufp->fullBit(oldp+14,(vlSelf->clk));
    bufp->fullBit(oldp+15,(vlSelf->reset));
    bufp->fullSData(oldp+16,(vlSelf->master_data),16);
    bufp->fullBit(oldp+17,(vlSelf->start));
    bufp->fullBit(oldp+18,(vlSelf->miso));
    bufp->fullBit(oldp+19,(vlSelf->done));
    bufp->fullSData(oldp+20,(vlSelf->data_received),16);
    bufp->fullBit(oldp+21,(vlSelf->sck));
    bufp->fullBit(oldp+22,(vlSelf->mosi));
    bufp->fullCData(oldp+23,(vlSelf->debug_state),3);
    bufp->fullBit(oldp+24,(vlSelf->ss));
    bufp->fullSData(oldp+25,(vlSelf->spi_dut__DOT__u_slave__DOT__sr_rx),16);
    bufp->fullCData(oldp+26,(vlSelf->spi_dut__DOT__u_slave__DOT__bit_count),4);
    bufp->fullBit(oldp+27,(vlSymsp->TOP__spi_dut__DOT__spi_if.miso));
}
