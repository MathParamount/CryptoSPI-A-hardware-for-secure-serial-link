...
VL_ATTR_COLD void Vspi_dut___024root__trace_init_sub__TOP__0(Vspi_dut___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+20,0,"master_data",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 15,0);
    tracep->declBit(c+21,0,"start",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBit(c+22,0,"miso",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    ...
    tracep->declBus(c+24,0,"data_received",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 15,0);
    tracep->declBit(c+25,0,"sck",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBit(c+26,0,"mosi",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBus(c+27,0,"debug_state",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 2,0);
    tracep->declBit(c+28,0,"ss",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    ...
    tracep->declBus(c+32,0,"DIV_HALF",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBit(c+8,0,"done_counter",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->popPrefix();
    tracep->pushPrefix("u_slave", VerilatedTracePrefixType::SCOPE_MODULE);
    tracep->pushPrefix("spi_if", VerilatedTracePrefixType::SCOPE_INTERFACE);
    Vspi_dut___024root__trace_init_sub__TOP__spi_dut__DOT__spi_if__0(vlSelf, tracep);
    tracep->popPrefix();
    tracep->declBus(c+33,0,"sr",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 15,0);
    tracep->declBus(c+12,0,"bit_count",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 6,0);
    ...
    tracep->declBit(c+14,0,"tx_load",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBus(c+15,0,"sr_tx",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 15,0);
    tracep->declBus(c+16,0,"sr_rx",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 15,0);
    tracep->popPrefix();
    tracep->popPrefix();
}
...
VL_ATTR_COLD void Vspi_dut___024root__trace_init_sub__TOP__spi_dut__DOT__spi_if__0(Vspi_dut___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBit(c+29,0,"mosi",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBit(c+17,0,"miso",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBit(c+30,0,"ss",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBus(c+20,0,"data_to_send",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 15,0);
    tracep->declBus(c+10,0,"data_received",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 15,0);
    tracep->declBit(c+21,0,"start",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1);
...
VL_ATTR_COLD void Vspi_dut___024root__trace_const_0_sub_0(Vspi_dut___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    // Body
    bufp->fullIData(oldp+31,(0x64U),32);
    bufp->fullIData(oldp+32,(0x32U),32);
    bufp->fullSData(oldp+33,(vlSelf->spi_dut__DOT__u_slave__DOT__sr),16);
}
...
VL_ATTR_COLD void Vspi_dut___024root__trace_full_0_sub_0(Vspi_dut___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullBit(oldp+8,(vlSelf->spi_dut__DOT__u_master__DOT__done_counter));
    bufp->fullBit(oldp+9,(vlSymsp->TOP__spi_dut__DOT__spi_if.sck));
    bufp->fullSData(oldp+10,(vlSymsp->TOP__spi_dut__DOT__spi_if.data_received),16);
    bufp->fullBit(oldp+11,(vlSymsp->TOP__spi_dut__DOT__spi_if.done));
    bufp->fullCData(oldp+12,(vlSelf->spi_dut__DOT__u_slave__DOT__bit_count),7);
    bufp->fullBit(oldp+13,(vlSelf->spi_dut__DOT__u_slave__DOT__rx_done));
    bufp->fullBit(oldp+14,(vlSelf->spi_dut__DOT__u_slave__DOT__tx_load));
    bufp->fullSData(oldp+15,(vlSelf->spi_dut__DOT__u_slave__DOT__sr_tx),16);
    bufp->fullSData(oldp+16,(vlSelf->spi_dut__DOT__u_slave__DOT__sr_rx),16);
    bufp->fullBit(oldp+17,(vlSymsp->TOP__spi_dut__DOT__spi_if.miso));
    bufp->fullBit(oldp+18,(vlSelf->clk));
    bufp->fullBit(oldp+19,(vlSelf->reset));
    bufp->fullSData(oldp+20,(vlSelf->master_data),16);
    bufp->fullBit(oldp+21,(vlSelf->start));
    bufp->fullBit(oldp+22,(vlSelf->miso));
    bufp->fullBit(oldp+23,(vlSelf->done));
    bufp->fullSData(oldp+24,(vlSelf->data_received),16);
    bufp->fullBit(oldp+25,(vlSelf->sck));
    bufp->fullBit(oldp+26,(vlSelf->mosi));
    bufp->fullCData(oldp+27,(vlSelf->debug_state),3);
    bufp->fullBit(oldp+28,(vlSelf->ss));
    bufp->fullBit(oldp+29,(vlSymsp->TOP__spi_dut__DOT__spi_if.mosi));
    bufp->fullBit(oldp+30,(vlSymsp->TOP__spi_dut__DOT__spi_if.ss));
}
