...
void Vcrypt_spi_dut___024root__trace_chg_0_sub_0(Vcrypt_spi_dut___024root* vlSelf, VerilatedFst::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[2U])) {
        bufp->chgQData(oldp+36,(vlSelf->crypt_spi_dut__DOT__u_slave__DOT__sr_tx),64);
        bufp->chgBit(oldp+38,(vlSelf->crypt_spi_dut__DOT__u_slave__DOT__ss_prev));
        bufp->chgBit(oldp+39,(vlSymsp->TOP__crypt_spi_dut__DOT__spi_if.miso));
    }
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[3U])) {
        ...
        bufp->chgQData(oldp+62,(vlSymsp->TOP__crypt_spi_dut__DOT__spi_if.miso_encrypted),64);
    ...
    bufp->chgQData(oldp+80,(vlSelf->mosi_encrypted),64);
    bufp->chgQData(oldp+82,(vlSelf->miso_encrypted),64);
    bufp->chgQData(oldp+84,(vlSelf->encrypt_text),64);
    bufp->chgQData(oldp+86,(vlSelf->ciphertext),64);
    bufp->chgBit(oldp+88,(vlSelf->crypto_ack));
    bufp->chgQData(oldp+89,(vlSelf->plaintext),64);
    bufp->chgBit(oldp+91,(vlSelf->crypt_spi_dut__DOT__u_master__DOT__last_block));
    bufp->chgSData(oldp+92,(vlSelf->crypt_spi_dut__DOT__u_master__DOT__block_count),16);
    bufp->chgQData(oldp+93,(vlSelf->crypt_spi_dut__DOT__u_slave__DOT__sr_rx),64);
